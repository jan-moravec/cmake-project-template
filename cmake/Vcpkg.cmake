...
function(run_vcpkg ENABLE_VCPKG_UPDATE)
  ...
  if(EXISTS "${VCPKG_DIR}" AND EXISTS "${VCPKG_DIR}/vcpkg${CMAKE_EXECUTABLE_SUFFIX}")
    ...
    execute_process(COMMAND "${GIT_EXECUTABLE}" "clone" "${VCPKG_URL}" "${VCPKG_DIR_NAME}"  WORKING_DIRECTORY ${VCPKG_PARENT_DIR} COMMAND_ERROR_IS_FATAL LAST)
    # Run vcpkg bootstrap
    if(WIN32)
